...
- `$env:PYTHONPATH='src'; python -m ai_engineering_runtime validation-collect --spec ai/doc/specs/20260322-005-validation-collect-foundation.md --command-status passed --black-box-status passed --white-box-status passed`
...
- updated stable runtime docs in `README.md` and `ai/doc/runtime/*` to reflect the implemented validation collector
