...
- `$env:PYTHONPATH='src'; python -m ai_engineering_runtime executor-dispatch --spec ai/doc/specs/20260322-007-executor-dispatch-adapter-shell.md --mode preview`
...
- updated stable runtime docs in `README.md` and `ai/doc/runtime/*` to reflect the implemented dispatch shell
