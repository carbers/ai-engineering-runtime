...
This round:
- aligned the repository identity in `README.md`, `AGENTS.md`, and `ai/doc/facts/project-scope.md`
...
- updated `ai/doc/specs/20260322-001-runtime-plan-to-spec-foundation.md` to `done`
...
- `python -m ai_engineering_runtime plan-to-spec --plan ai/doc/runtime/roadmap.md --dry-run`
- `python -m ai_engineering_runtime plan-to-spec --plan ai/doc/runtime/roadmap.md --output ai/doc/specs/20260322-999-runtime-plan-to-spec-validation.md`
...
- updated `ai/doc/facts/project-scope.md` to reflect the runtime project identity and current phase boundaries
- minimally refined `ai/skill/plan-to-spec.md` and `ai/doc/templates/plan-template.md` for the runtime-compilable `First Slice` contract
