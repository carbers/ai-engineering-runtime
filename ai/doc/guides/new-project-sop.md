...
1. keep the entrypoints split: root `README.md` for humans, `AGENTS.md` and adapters for AI tools, `ai/README.md` for the `ai/doc/*` and `ai/skill/*` namespace
...
- keep `ai/README.md` as the namespace map for the copied SOP workflow assets
- in this runtime repo, keep runtime-specific system docs under `ai/doc/runtime/*`
