...
- `ai/doc/runtime/architecture.md`
- `ai/doc/runtime/state-machine.md`
- `README.md`
...
- Black-box validation completed with `python -m unittest tests.test_executor_dispatch tests.test_cli tests.test_followup_package -v`, `python -m unittest discover -s tests -v`, and `$env:PYTHONPATH='src'; python -m ai_engineering_runtime executor-dispatch --spec ai/doc/specs/20260327-001-executor-adapter-codex-v1.md --executor codex --mode submit`