...
If the plan should be runtime-compilable, this section may optionally use `###` subheadings with the contract described in `ai/doc/runtime/protocol.md`, including:
- `Spec Title`
- `In Scope`
- `Out of Scope`
- `Affected Area`
