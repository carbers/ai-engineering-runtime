...
Use `ai/` to keep workflow assets aligned with `ai-engineering-sop` and separate from project-facing product documentation.
...
In this repository, runtime-specific design docs and task-local closeout notes live inside `ai/doc/runtime/*` and `ai/doc/change-summaries/*` for alignment with the SOP namespace.
