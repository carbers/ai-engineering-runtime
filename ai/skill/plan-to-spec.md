...
If the plan should be compiled by `ai-engineering-runtime`, make the `First Slice` section explicit with the `###` contract fields described in `ai/doc/runtime/protocol.md`.
