...
- `$env:PYTHONPATH='src'; python -m ai_engineering_runtime task-spec-readiness-check --spec docs/specs/20260322-004-task-spec-readiness-check.md`
...
- updated stable runtime docs in `README.md` and `docs/runtime/*` to reflect the implemented task-spec gate
