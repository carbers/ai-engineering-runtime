...
### Related Specs
- `docs/specs/20260322-001-runtime-plan-to-spec-foundation.md`
- `docs/specs/20260322-016-validation-rollup-policy.md`
- `docs/specs/20260322-017-writeback-package-builder.md`
- `docs/specs/20260322-018-followup-package-builder.md`
...
- add stable workflow examples to `docs/facts/golden-cases.md`
