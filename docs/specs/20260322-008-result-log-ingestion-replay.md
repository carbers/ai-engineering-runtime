...
## Write-back Needed
Yes, but keep it narrow by updating `docs/runtime/protocol.md` and `README.md` only if the replay contract and CLI semantics stabilize during implementation. Do not add facts or skills by default from this slice.
