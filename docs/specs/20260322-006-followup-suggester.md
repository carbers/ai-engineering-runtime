...
### White-box Trigger
This slice introduces a control-plane decision node with competing upstream signals. Black-box checks alone will not reliably protect the priority order and boundary between “continue”, “fix”, “clarify”, and “close out”.
